-- CreateEnum
CREATE TYPE "Role" AS ENUM ('LEARNER', 'CREATOR', 'ADMIN');

-- CreateEnum
CREATE TYPE "CourseStatus" AS ENUM ('PENDING', 'APPROVED', 'PUBLISHED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Certificate_serialHash_key" ON "Certificate"("serialHash");
